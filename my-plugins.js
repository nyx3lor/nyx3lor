...
function translate_tv() {
    ...
    var translate_tv = localStorage.getItem('interface_custom_translate_tv')  === 'true';
    var translate_tv_style;
    $('#interface_custom_translate_tv').remove(); 
    if (!translate_tv) {
    ...
    function startPlugin() {
        ...
        if (!localStorage.getItem('interface_custom_translate_tv')) {
            localStorage.setItem('interface_custom_translate_tv', 'true');
        }
        ...
        Lampa.SettingsApi.addParam({
            ...
            param: {
                name: 'interface_custom_translate_tv',
                type: "trigger",
                default: true
            },
            field: {
                name: Lampa.Lang.translate('interface_custom_translate_tv'),
                description: ''
            },
