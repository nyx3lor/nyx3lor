(function() {
    ...
    // Дополнительные шаблоны, не меняющиеся (как в оригинале)
    function forall() {
        ...
        // Стили (нейтральные; скрытие иконки TV всегда, как в оригинале без переключателя)
        var forall_style = "\n<style id=\"ui_enhancer_forall\">\n " +
            ...
            // Скрытие иконки TV (всегда, без переключателя)
    ...
    function bigbuttons() {
        ...
        if (bigbuttons) {
            var bigbuttons_style = "\n<style id=\"ui_enhancer_bigbuttons\">\n " +
                // Показываем спаны на десктопе, скрываем на мобильных для не-фокусных (логично и без нарушений)
    ...
    function startPlugin() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function(value) {
                window.location.reload();  // Перезагрузка как в оригинале для применения макета
            }
        });
