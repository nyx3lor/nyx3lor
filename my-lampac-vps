(function() {
    ...
    var default_server = '193.169.241.242:12127';
    ...
    function startMe() {
        ...
        $('#REDIRECT').on('hover:enter hover:click hover:touch', function() {
            window.location.href = server_protocol + default_server;
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            param: {
                ...
                type: 'input',
                values: '',
                placeholder: 'Сервер: 193.169.241.242:12127',
                default: default_server
            },
            field: {
                name: 'Адрес сервера',
                description: 'Этот адрес установлен по умолчанию и сменить нельзя'
            },
            onChange: function (value) {
                // Игнорируем, адрес всегда фиксирован
            }
        });
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                ...
                description: 'Редирект всегда включён и не отключается'
            }
        });
