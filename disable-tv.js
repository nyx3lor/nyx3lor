(function() {
    ...
    function applyTheme(theme) {
        ...
        // Создаем новый стиль
        var style = $('<style id="lampa_ui_theme"></style>');
    ...
    function removeAdditionalSettings() {
        Lampa.Settings.listener.follow('open', function(e) {
            if (e.name == 'lampa_ui') {
                e.body.find('[data-name="lampa_ui_animations"]').remove();
                e.body.find('[data-name="lampa_ui_translate_tv"]').remove();
                e.body.find('[data-name="lampa_ui_incardtemplate"]').remove();
                e.body.find('[data-name="lampa_ui_bigbuttons"]').remove();
            }
        });        
    }
    ...
    function incardtemplate() {
        var incardtemplate = localStorage.getItem('lampa_ui_incardtemplate')  === 'true';
        if (incardtemplate) {
...
function translate_tv() {
    var tv_caption = Lampa.Lang.translate('lampa_ui_tvcaption');
    var translate_tv = localStorage.getItem('lampa_ui_translate_tv')  === 'true';
    var translate_tv_style;
    $('#lampa_ui_translate_tv').remove(); 
    if (!translate_tv) {
        translate_tv_style = "\n<style id=\"lampa_ui_translate_tv\">\n " +
            ".card__type  {\n  display: none;\n}\n " +
            ".card--tv .card__type {\n  display: none;\n}\n" +
        "</style>\n";
    ...
    function animations() {
        var animations = localStorage.getItem('lampa_ui_animations') === 'true';
    ...
    function bigbuttons() {
        var bigbuttons = localStorage.getItem('lampa_ui_bigbuttons')  === 'true';
        $('#lampa_ui_bigbuttons').remove();
        if (bigbuttons) {
            var bigbuttons_style = "\n<style id=\"lampa_ui_bigbuttons\">\n " +
    ...
    function startPlugin() {
        ...
        if (!localStorage.getItem('lampa_ui_animations')) {
            localStorage.setItem('lampa_ui_animations', 'true');
        }
        if (!localStorage.getItem('lampa_ui_translate_tv')) {
            localStorage.setItem('lampa_ui_translate_tv', 'true');
        }
        if (!localStorage.getItem('lampa_ui_incardtemplate')) {
            localStorage.setItem('lampa_ui_incardtemplate', 'false');
        }   
        if (!localStorage.getItem('lampa_ui_bigbuttons')) {
            localStorage.setItem('lampa_ui_bigbuttons', 'false');
        }
        // Меню        
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: Lampa.Lang.translate('lampa_ui_theme'),
                description: ''
            },
            onChange: function onChange(value) {
                lampa_ui.settings.theme = value;
        ...
        Lampa.SettingsApi.addParam({
            component: 'lampa_ui',
            param: {
                name: 'lampa_ui_incardtemplate',
                type: "trigger",
                default: false
            },
            field: {
                name: Lampa.Lang.translate('lampa_ui_incardtemplate'),
                description: ''
            },
            onChange: function(value) {
        ...
        Lampa.Settings.listener.follow('open', function(e) {
            if (e.name == 'interface') {
                $("div[data-name=interface_size]").after($("div[data-name=lampa_ui_selected]"));
            }
        }); */
