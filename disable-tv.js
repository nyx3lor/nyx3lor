(function() {
    ...
    function applyCustomizations() {
        $('#card_custom_theme').remove();

        removeAdditionalSettings();

        var style = $('<style id="card_custom_theme"></style>');
        // No theme CSS
    ...
    function removeAdditionalSettings() {
        Lampa.Settings.listener.follow('open', function(e) {
            if (e.name == 'card_custom') {
                e.body.find('[data-name="card_custom_animations"]').remove();
                e.body.find('[data-name="card_custom_translate_tv"]').remove();
                e.body.find('[data-name="card_custom_incardtemplate"]').remove();
                e.body.find('[data-name="card_custom_bigbuttons"]').remove();
            }
        });        
    }
    ...
    function forall() {
        ...
        var forall_style = "\n<style id=\"card_custom_forall\">\n " +
            ...
            ".explorer__files .torrent-filter .simple-button {font-size: 1.2em;\n-webkit-border-radius: 0.5em;\n-moz-border-radius: 0.5em;\nborder-radius: 0.5em;\n}\n" +
    ...
    function incardtemplate() {
        var incardtemplate = localStorage.getItem('card_custom_incardtemplate')  === 'true';
        if (incardtemplate) {
    ...
    function animations() {
        var animations = localStorage.getItem('card_custom_animations') === 'true';
        $('#card_custom_animations').remove();
        if (animations) {
            var animations_style = "\n<style id=\"card_custom_animations\">\n " +
                ...
                ".selectbox-item,\n.settings-folder,\n.settings-param { transition: transform 0.3s ease;\n}\n" +
    ...
    function bigbuttons() {
        var bigbuttons = localStorage.getItem('card_custom_bigbuttons')  === 'true';
        $('#card_custom_bigbuttons').remove();
        if (bigbuttons) {
            var bigbuttons_style = "\n<style id=\"card_custom_bigbuttons\">\n " +
    ...
    function startPlugin() {
        ...
        if (!localStorage.getItem('card_custom_bigbuttons')) {
            localStorage.setItem('card_custom_bigbuttons', 'false');
        }
        Lampa.SettingsApi.addComponent({
            component: "card_custom",
            name: Lampa.Lang.translate('card_custom'),
            icon: themes_svg
        });
        ...
        Lampa.SettingsApi.addParam({
            component: 'card_custom',
            param: {
                name: 'card_custom_animations',
                type: "trigger",
                default: true
            },
            field: {
                name: Lampa.Lang.translate('card_custom_animations'),
                description: ''
            },
        ...
        Lampa.SettingsApi.addParam({
            component: 'card_custom',
            param: {
                name: 'card_custom_translate_tv',
                type: "trigger",
                default: true
            },
            field: {
                name: Lampa.Lang.translate('card_custom_translate_tv'),
                description: ''
            },
            onChange: function(value) {
                translate_tv();
        ...
        Lampa.SettingsApi.addParam({
            component: 'card_custom',
            param: {
                name: 'card_custom_incardtemplate',
                type: "trigger",
                default: false
            },
            field: {
                name: Lampa.Lang.translate('card_custom_incardtemplate'),
                description: ''
            },
            onChange: function(value) {
        ...
        Lampa.SettingsApi.addParam({
            component: 'card_custom',
            param: {
                name: 'card_custom_bigbuttons',
                type: "trigger",
                default: false
            },
            field: {
                name: Lampa.Lang.translate('card_custom_bigbuttons'),
                description: ''
            },
            onChange: function(value) {
                bigbuttons();
    ...
    Lampa.Manifest.plugins = {
        name: 'card_custom',
        version: '2.6.1',
        description: 'card_custom'
    };

    window.card_custom = card_custom;
})();
